...
extension ComputerCoreData {

    @nonobjc public class func fetchRequest() -> NSFetchRequest<ComputerCoreData> {
        return NSFetchRequest<ComputerCoreData>(entityName: "Computer")
    }
    ...
    @NSManaged public var introduced: String?
    @NSManaged public var discounted: String?
    @NSManaged public var imageUrl: String?
    @NSManaged public var computerDescription: String?
